package maratonaJava.objetos.ZZJcrud.repository;


import lombok.extern.log4j.Log4j2;
import maratonaJava.objetos.ZZJcrud.conn.ConnectionFactory;
...
public class AnimeRepository {
    ...
    public static void save(Anime anime) {
        log.info("Saving Producer '{}'", anime);
        try (Connection conn = ConnectionFactory.getConnection();
             PreparedStatement ps = createPrepareStatementSave(conn, anime)) {
            ps.execute();
        } catch (SQLException e) {
            log.error("Error while trying to update producer '{}'", anime.getId(), e);
        }
    }
