package maratonaJava.objetos.ZZJcrud.service;

import maratonaJava.objetos.ZZJcrud.dominio.Anime;
import maratonaJava.objetos.ZZJcrud.dominio.Producer;
import maratonaJava.objetos.ZZJcrud.repository.AnimeRepository;
import maratonaJava.objetos.ZZJcrud.repository.ProducerRepository;
...
public class AnimeService {
    ...
    private static void findByName() {
       ...
       AnimeRepository.findByName(name)
                .forEach(p -> System.out.printf("[%d] - %s %d %s%n", p.getId(), p.getName(), p.getEpisodes(), p.getProducer(), p.getName()));
    }
